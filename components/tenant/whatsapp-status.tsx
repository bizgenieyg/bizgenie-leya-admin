...
export default function WhatsAppStatus({ onStatusChange }: { onStatusChange?: (status: string) => void }) {
  ...
  return <WhatsAppConnection cabinet canEdit={canEdit} onStatusChange={onStatusChange} />;
}
