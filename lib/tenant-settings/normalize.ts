...
export function normalizeTenantSettings(value:unknown){const raw=object(value);return{
 ...
 time_zone:typeof raw.time_zone==='string'?raw.time_zone:'Asia/Jerusalem',supported_time_zones:strings(raw.supported_time_zones,DEFAULT_TIME_ZONES),weekly_schedule:schedule(raw.weekly_schedule),
