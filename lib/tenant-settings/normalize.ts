...
export function normalizeTenantSettings(value:unknown){const raw=object(value);return{
 ...
 auto_replies_paused:raw.auto_replies_paused===true,translate_owner_answer:raw.translate_owner_answer===true,polish_owner_answer:raw.polish_owner_answer!==false,escalation_remind_minutes:number(raw.escalation_remind_minutes,120),escalation_close_minutes:number(raw.escalation_close_minutes,1440),
