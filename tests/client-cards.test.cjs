...
test('client cabinet exposes search, safe mutations, preserved-history deletion and summary periods',()=>{
 ...
 for(const text of ['Пока никто не обращался','Поиск по имени или номеру','Больше не отвечать автоматически','История сообщений сохранится','Последние сообщения'])assert.match(directory,new RegExp(text));
